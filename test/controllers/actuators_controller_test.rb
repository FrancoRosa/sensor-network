...
class ActuatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actuator" do
    assert_difference('Actuator.count') do
      post actuators_url, params: { actuator: { current_status: @actuator.current_status, device_id: @actuator.device_id, element_id: @actuator.element_id, expected_status: @actuator.expected_status } }
    end
  ...
  test "should update actuator" do
    patch actuator_url(@actuator), params: { actuator: { current_status: @actuator.current_status, device_id: @actuator.device_id, element_id: @actuator.element_id, expected_status: @actuator.expected_status } }
