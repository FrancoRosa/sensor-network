...
class ActuatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actuator" do
    assert_difference('Actuator.count') do
      post actuators_url, params: { actuator: { current_status: @actuator.current_status, device: @actuator.device, element: @actuator.element, expected_status: @actuator.expected_status } }
    end
  ...
  test "should update actuator" do
    patch actuator_url(@actuator), params: { actuator: { current_status: @actuator.current_status, device: @actuator.device, element: @actuator.element, expected_status: @actuator.expected_status } }
