...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { device: @sensor.device, value: @sensor.value, variable: @sensor.variable } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { device: @sensor.device, value: @sensor.value, variable: @sensor.variable } }
